...
const GroupDetails: React.FC = () => {
  ...
  const getCurrentUserId = useCallback((): string => currentUserId || '', [currentUserId]);
  ...
  const { 
    ...
    closePaymentModal, 
    markAsPaid 
  } = usePayment(getCurrentUserId, useCallback(() => fetchGroupData(groupId!), [fetchGroupData, groupId]));
  ...
  // Event handlers
  const handlePayNow = useCallback((balance: any) => {
    if (!groupId) return;
  ...
  const checkCompletedPayment = useCallback((balance: any) => {
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-lg shadow mb-6">
          <div className="flex border-b overflow-x-auto scrollbar-hide">
            ...
            >
              <span className="hidden sm:inline">Members ({group?.members.length || 0})</span>
              <span className="sm:hidden text-xs">👥 {group?.members.length || 0}</span>
            </button>
          </div>
          ...
          <div className="p-3 sm:p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mb-4 sm:mb-6">
              ...
              {group && group.members.length > 1 && (
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
                  ...
                  >
                    ...
                    <span>{showReceiptScanner ? 'Cancel Scan' : 'Scan Receipt'}</span>
                  </button>
                  <button
                    onClick={() => {
              ...
              {group && group.members.length === 1 && currentUserRole === 'admin' && (
                ...
                <>
                  {isCurrentUserCreditor && groupHasOutstandingDebts ? (
                    ...
                    !groupHasOutstandingDebts && (
                      <div className="w-10 text-xs text-gray-500 italic px-3 py-2 bg-gray-50 rounded-lg">
            ...
            {showReceiptScanner && (
              <div className="bg-white rounded-lg shadow border border-slate-200 p-6 mb-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-sm sm:text-lg font-semibold text-gray-900">Scan Group Receipt</h3>
                    <p className="text-xs sm:text-sm text-gray-600">Extract expense data from receipt</p>
                  </div>
                </div>
                    ...
                    <div key={expense._id} className="bg-white rounded-lg shadow border border-slate-200 p-4">
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                        <div className="flex-1 min-w-0">
                          <h3 className="font-semibold text-sm sm:text-lg text-gray-900 mb-1 truncate">{expense.description}</h3>
              ...
              <div className="space-y-4">
                {balances.map((balance) => (
                  ...
                  >
                    ...
                    {balance.userId === getCurrentUserId() && (
                      <>
                        {balance.status === 'settled' || checkCompletedPayment(balance) ? (
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mb-1">
                              ...
                              <div className="flex items-center gap-1 sm:gap-2">
                                ...
                                {isAdmin && (
                                  <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full whitespace-nowrap">Admin</span>
                                )}
                              </div>
                            </div>
                ...
                {group?.members.length === 1 && (
                  <div className="text-center py-6 sm:py-8 bg-blue-50 rounded-lg border-2 border-dashed border-blue-200">
                    ...
                    <p className="text-blue-600 text-xs sm:text-sm px-4">
                      Use the "Add Member" button above to invite people to your group.
                    </p>
                  </div>
                )}
